...
**Project Overview**        
This repository contains the final project for DS 4021: Machine Learning, focused on predicting student math performance using socioeconomic and behavioral variables. Four machine learning models, Elastic Net, Support Vector Regression, Gradient Boosting, and a PyTorch neural network, were implemented, tuned using cross-validation, and evaluated on a held-out test set. All code, documentation, and results are organized for clarity and reproducibility.
